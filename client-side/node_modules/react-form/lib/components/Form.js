...
var Form = function (_Component) {
  ...
  function Form(props) {
    ...
    _this.preSubmit = function (values) {
      var newValues = _utils2.default.clone(values);
      _this.recurseUpAllNodes(function (node) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 30:
                ...
                _this.props.onSubmitFailure({}, _context7.t1, _this.getFormApi());
                _context7.next = 37;
                break;
